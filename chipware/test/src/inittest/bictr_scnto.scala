...
class bictr_scnto(val WIDTH: Int = 3, val COUNT_TO: Int = 2) extends RawModule {
  ...
  protected val U1: CW_bictr_scnto = Module(new CW_bictr_scnto(WIDTH, COUNT_TO))
  U1.io.data  := io.data
...
object bictr_scnto extends TestSuite {
  val tests: Tests = Tests {
    test("should instantiate bictr_scnto") {
      def top = new bictr_scnto()
