...
class fp_exp2(val sig_width: Int = 23, val exp_width: Int = 8, val ieee_compliance: Int = 1, val arch: Int = 0)
    extends RawModule {
...
object fp_exp2 extends TestSuite {
  val tests: Tests = Tests {
    test("should instantiate fp_exp2") {
      def top = new fp_exp2()
