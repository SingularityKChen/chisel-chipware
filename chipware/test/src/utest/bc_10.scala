...
class bc_10 extends RawModule {
  ...
  // Instantiate the BlackBox class
  protected val U1: CW_bc_10 = Module(new CW_bc_10())
...
object bc_10 extends TestSuite {
  val tests: Tests = Tests {
    test("should instantiate bc_10") {
      def top = new bc_10()
