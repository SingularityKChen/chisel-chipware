 ...
 */
class CW_fp_cmp(val sig_width: Int = 23,
                val exp_width: Int = 8,
                val ieee_compliance: Int = 1,
                val quieten_nans: Int = 1) extends BlackBox(Map(
  "sig_width" -> sig_width,
  "exp_width" -> exp_width,
  ...
  require(List(0, 1, 3).contains(ieee_compliance), s"ieee_compliance must be either 0, 1, or 3, but got $ieee_compliance")
